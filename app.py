...
st.write("""This is my very first machine learning web-based application. The main idea of this program is to connect machine learning algorithm with website so that the user can use it
""")  
...
st.pyplot() 
"""It is very hard to identify the biggest parameter that affect the Severity of , that is why i can say that rapid test and swab test is kinda rubbing your wallet :("""
